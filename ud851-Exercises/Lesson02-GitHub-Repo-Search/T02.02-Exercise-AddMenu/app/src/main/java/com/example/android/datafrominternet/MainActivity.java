...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        int clickedIdemId = item.getItemId();
        ...
        if(clickedIdemId == R.id.action_search){
        ...
        // COMPLETED (15) If you do NOT handle the menu click, return super.onOptionsItemSelected
        // to let Android handle the menu click
